...
|---|---|---|---|---|---|---|---|
| 1 | `public/images/vision-motors-technicians-engine-bay-pretoria.jpg` | 1024×682 | Team at work | ✅ Real | Good | **Very high** | **In use — hero anchor (v5), + /about-us + /our-work.** Best asset by a wide margin. On the homepage it is now the dominant editorial hero crop (`object-[center_28%]`), a DIFFERENT crop/purpose from About/Our-Work (Correction 4). The client-supplied oil image is no longer used on the homepage. |
