...
export const faqConfig: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "We have two workshops on Steve Biko Road, Pretoria: Vision Motors at 1059 Steve Biko Rd, and The Engine Shop / Vision Motors at 1197 Steve Biko Rd. Call our company line on 012 335 0070, or call/WhatsApp a branch directly — Vision Motors on 082 823 5178 and The Engine Shop / Vision Motors on 069 007 2402 — Monday to Friday, 07:30 to 17:00. You can also send your details through the booking form and we'll confirm which branch to bring your vehicle to.",
  },
];
