...
export const faqConfig: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "We have two workshops in Wonderboom South, Pretoria: Vision Motors at 867 M5, and The Engine Shop / Vision Motors at 999 Steve Biko Rd. Call our company line on 012 335 0070, or call/WhatsApp a branch directly — Vision Motors on 082 823 5178 and The Engine Shop / Vision Motors on 071 048 8213 — Monday to Friday, 07:30 to 17:00. You can also send your details through the booking form and we'll confirm which branch to bring your vehicle to.",
  },
];
