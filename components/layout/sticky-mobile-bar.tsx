    ...
    >
      <div className="flex items-center gap-2.5 px-3 py-2.5">
        ...
        <a
          ...
          className="inline-flex min-h-[48px] flex-[1.7] items-center justify-center gap-2 rounded-md bg-brand-cta text-sm font-bold text-brand-ink shadow-accent active:scale-[0.98]"
        ...
        <Link
          ...
          className="inline-flex min-h-[48px] flex-1 items-center justify-center rounded-md border border-white/25 bg-white/5 text-sm font-bold text-white active:scale-[0.98]"
        >
