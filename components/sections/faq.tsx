...
export default function Faq() {
  ...
  return (
    <SectionContainer id="faq" className="bg-brand-ink">
                ...
                <div key={item.question}>
                  <dt>
                    <button
                      ...
                      className="flex w-full items-center justify-between gap-6 py-6 text-left transition-colors hover:text-brand-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent"
                    >
                  ...
                  <dd
                    ...
                    hidden={!isOpen}
                  >
                    <p className="max-w-[65ch] pb-6 text-sm leading-relaxed text-white/60">
                      {item.answer}
                    </p>
                  </dd>
                </div>
