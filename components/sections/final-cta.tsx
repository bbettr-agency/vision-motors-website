...
export default function FinalCta() {
  return (
    <section
      id="book"
      className="relative overflow-hidden border-t border-white/10 bg-brand-charcoal px-6 py-20 md:py-28 lg:px-8"
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <ul className="mt-10 space-y-5">
            <li>
              <a
                ...
                className="group inline-flex min-h-[44px] items-start gap-3.5"
              ...
              >
                ...
                <span>
                  ...
                  <span className="mt-0.5 block whitespace-nowrap font-display text-lg font-bold text-white transition-colors group-hover:text-brand-accent">
            ...
            <li>
              ...
              >
                ...
                <span>
                  ...
                  <span className="mt-0.5 block break-all text-sm font-medium text-white transition-colors group-hover:text-brand-accent">
                    {siteConfig.email}
                  </span>
                </span>
              </a>
        ...
        >
          <div className="rounded-3xl border border-white/10 bg-brand-graphite p-6 shadow-ink sm:p-8">
